...
@section('content')
    ...
    <div class="container">
        <br>
        <br>
        <h2 style="text-align: center">{{ trans('site.Registre de doléances du réseau comptable') }}</h2>
        <br><br>
        <div class="row ">
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="row pl-3">
                                ...
                                <div class="form-group col-xs-6 w-50 pr-3">
                                    <label for="nom">
                                        <h5>{{trans('site.Nom et Prénom')}} <span style="color: red">*</span>:</h5>
                                    </label>
                                ...
                                <div class="form-group w-50 pr-3 ">
                                    ...
                                    <div class="input-group mb-2 gSecteur">
                                        ...
                                        <select class="form-control" id="secteur" name="secteur" required>
                                            <option value=""></option>
                                            <option value="1">Activite 1</option>
                                            <option value="2">Activite 2</option>
