...
<header style="margin-top: -50px">
    ...
    <!-- HTML -->
{{--    <div class="example1">--}}
{{--        <h3>Bienvenue sur le site de la Direction Générale de la Comptabilité</h3>--}}
{{--    </div>--}}
{{--        <div style="color: #FFFFFF;  font: normal 24px 'arial', sans-serif; background-color: #0066FF; border: #C0C0C0 1px solid;width: 100%; margin: 0 auto; padding: 4px 5px 3px 5px;">--}}
{{--            <marquee scrollamount="8" >--}}
{{--                <label style="color: #FFFFFF;  font: normal 24px 'arial', sans-serif; background-color: #0066FF">Bienvenue sur le site de la Direction Générale de la Comptabilité</label>--}}
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
                           style="color:white;font-weight: bold" role="button" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false">{{ trans('site.Langue') }}
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <div class="navbar-nav navbar-right nvrght">
                    ...
                    {{--the user is login--}}
                    @auth
                        <a class="btn btn-outline-danger h-25 my-2 my-sm-0" href="{{ route('logout') }}"><i
                    ...
                    @guest
                        <a class="btn btn-outline-success bg-white h-25 my-2 my-sm-0" id="btnlog" type="submit"
                           href="{{ route('login') }}"><i
                                class="fa fa-sign-in"></i>
...
<div class="mt-2 pt-2 pb-2 footer">
    <div class="container">
        <h4 class="text-center" style="color: white">Direction Générale de la Comptabilité / Trésor public</h4>
        <br>
        <div class="row">
            <div class="col-lg-6 col-xs-12 location">


                <h4 class="mt-lg-0 mt-sm-4" style="color: white"><i
                        class="fa fa-location-arrow"></i> {{ trans('site.Localisation') }}</h4>
                <br>
