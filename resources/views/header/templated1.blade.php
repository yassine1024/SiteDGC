...
{{--    <img id="imgtop" src="{{asset('assets/images/Imageheader.png')}}" width="100%" height="90px">--}}
    ...
    <!-- HTML -->
{{--    <div class="example1">--}}
{{--        <h3>Bienvenue sur le site de direction générale de la comptabilité </h3>--}}
{{--    </div>--}}
...
{{--                <label style="color: #FFFFFF;  font: normal 24px 'arial', sans-serif; background-color: #0066FF">Bienvenue sur le site de direction générale de la comptabilité  </label>--}}
